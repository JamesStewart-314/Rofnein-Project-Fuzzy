...
ataque_img = MyFunctions.pygame_scale_img(ataque_img,
                (int(ataque_img_Width * 0.6 * Game_Constants.Custom_ataque_constant),
                int(ataque_img_Height * 0.6 * Game_Constants.Custom_ataque_constant)))
...
vida_img = MyFunctions.pygame_scale_img(vida_img,
                (int(vida_img_Width * 0.8 * Game_Constants.Custom_ataque_constant),
                int(vida_img_Height * 0.8 * Game_Constants.Custom_ataque_constant)))
