...
First_Level_Music = MySound.MySound("first_level_stand_music", 0.5)
Second_Level_Music = (MySound.MySound("second_level_stand_music", 0.3), MySound.MySound("second_level_combat_music", 0.3))
Dungeon_Music = MySound.MySound("dungeon_stand_music", 0.5)
Dungeon2_music = MySound.MySound("dungeon_combat_music", 0.3)
